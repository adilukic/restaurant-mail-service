package com.example.restaurantmailservice.security;

import com.example.restaurantmailservice.security.service.TokenService;
...
public class SecurityAspect {
    ...
    @Around("@annotation(com.example.restaurantmailservice.security.CheckSecurity)")
